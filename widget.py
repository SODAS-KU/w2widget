...
class Widget:
    ...
    def create_widgets(self):
        ...
        self.download_output = self.generate_download_output()
    ...
    def on_generate_sample_button_click(self, change):
        ...
        self.document_output.layout.height = "200px"
        self.document_output.layout.min_height = "200px"
        self.document_output.layout.max_height = "200px"
    ...
    def on_save_file_click(self, change):
        data = json.dumps(self.topics, separators=(",", ":"))
        print(data)
        self.trigger_download(data)
...
a:hover {
    ...
    def generate_download_output(self):
        return widgets.Output(
            layout={"height": "0px", "max_height": "0px", "min_height": "0px"}
        )

    def trigger_download(self, data):
        data_url = f"data:text/json;charset=utf-8;,{data}"
        js_code = f"""
                                ...
                                widgets.VBox(
                                    [
                                        ...
                                        widgets.Box(
                                            ...
                                            layout=Layout(
                                                max_height="200px", display="overflow"
                                            ),
                                        ),
                                    ],
